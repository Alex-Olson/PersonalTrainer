...
//saves clients/weigh-ins to json file.
{
    ...
    public ArrayList<WeighIn> loadWeighIns() throws IOException, JSONException {
        ...
        try{
            ...
            for (int i = 0; i < array.length(); i++){
                weighIns.add(new WeighIn(array.getJSONObject(i)));
            }
    ...
    public void saveWeighIns(ArrayList<WeighIn> weighIns)
